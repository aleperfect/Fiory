...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} BotRosita
  ${tradutor.texto1[2]} +59891477871
  ${tradutor.texto1[3]} https://chat.whatsapp.com/Js1WPV9tUIGFLiufsL2PEO
  ...
  const Message = {
    document: { url: `https://chat.whatsapp.com/Js1WPV9tUIGFLiufsL2PEO` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://chat.whatsapp.com/Js1WPV9tUIGFLiufsL2PEO",
        mediaType: 2,
        previewType: "pdf",
        title: "BotRosita",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://chat.whatsapp.com/Js1WPV9tUIGFLiufsL2PEO",
      },
    },
    caption: info,
    footer: wm,
